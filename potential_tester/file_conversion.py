...
'''
def fix_atomic_numbers(x, material='SiO2'):
    ...
    if material == 'SiO2':
        ...
        raise Exception(f"unsupported matieral: {material}")    
...
def read_reg(file_in, material = 'SiO2'):
    return fix_atomic_numbers(_read_any(file_in), material=material)
...
def convert_and_regularize_file(file_in, file_out, out_type='lammps', style=None, material='SiO2'):
    atoms = read_reg(file_in, material=material)
